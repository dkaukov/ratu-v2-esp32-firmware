            ...
            <div class="card-icon pb-3 pt-4 px-4 has-background-primary-light has-text-primary">
              <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  ...
                  <rect fill="currentColor" x="4" y="5" width="16" height="3" rx="1.5"></rect>
                  <path d="M5.5 15h13a1.5 1.5 0 010 3h-13a1.5 1.5 0 010-3zm0-5h7a1.5 1.5 0 010 3h-7a1.5 1.5 0 010-3z" fill="currentColor" opacity=".3"></path>
                </g>
              </svg>
            </div>
          </div>
          <div class="column">
            <h6 class="is-size-6 has-text-muted">
              {{ card.name }} (
              <span class="has-text-dark has-text-weight-semibold"
                >{{ card.value }} <small class="is-size-6">{{ card.symbol }}</small></span
              >
              )
            </h6>
