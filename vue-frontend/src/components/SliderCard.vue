          ...
          <div class="column">
            <h6 class="is-size-6 has-text-muted">
              ...
              <span class="has-text-dark has-text-weight-semibold"
                >{{ displayValue }} <small class="is-size-6 has-text-weight-semibold">{{ card.symbol }}</small></span
              >
              )
            </h6>
