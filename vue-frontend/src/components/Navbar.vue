        ...
        <div class="navbar-brand">
          <router-link class="navbar-item" to="/">
            <svg xmlns="http://www.w3.org/2000/svg" width="120px" viewBox="0 0 365.79 100.8">
              <path d="M202.31,44.93a32.79,32.79,0,0,1,7.33-2.47c13.11-2.49,26.17,3.67,30,19.43a38.39,38.39,0,0,1,1,9V93.62c0,2.54-.9,3.42-3.47,3.42H224c-2,0-2.93-.94-2.93-2.94V69.93a11.8,11.8,0,0,0-1.41-5.73c-2.82-5.2-10.11-6.61-14.39-2.73-2.43,2.2-3,5.19-3,8.3v24c0,2.65-.59,3.23-3.23,3.23H185.53c-2.47,0-3.36-.9-3.36-3.4V6.32c0-2.44.88-3.32,3.29-3.32h13.66c2.26,0,3.18.91,3.18,3.18V44.93Z" style="fill: #2b2b2b" />
              <path
                ...
                style="fill: #2b2b2b"
              />
              <path d="M57,2.86H43.36c-2.67,0-3.49.82-3.49,3.5V44.22a28.2,28.2,0,0,0-16-2.08c-6.75,1.06-12.4,4-16.55,9.56A28.12,28.12,0,0,0,2,67.17c-.6,9.6,2.17,18,9.33,24.47,8.85,8.06,23.16,9,32.54.88a34.63,34.63,0,0,0,2.65-2.9c.45,1.2.7,2,1.06,2.84s.65,1.65,1,2.44a3,3,0,0,0,3.11,2c1.71-.06,3.43,0,5.15,0C59,96.9,60,96,60,93.79V5.86C60,3.8,59,2.86,57,2.86ZM42,70A10.65,10.65,0,0,1,31.57,80.87H31.2a10.87,10.87,0,0,1,.21-21.73A10.53,10.53,0,0,1,42,69.6C42,69.74,42,69.87,42,70Z" style="fill: #2b2b2b" />
              <path
